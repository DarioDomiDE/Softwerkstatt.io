<template>
  <div class="container mx-auto max-w-screen-lg xl:max-w-screen-lg pt-16 px-4 lg:px-0 pb-32">
    ...
    <p>Im Falle datenschutzrechtlicher Verstöße steht dem Betroffenen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Zuständige Aufsichtsbehörde in datenschutzrechtlichen Fragen ist der Landesdatenschutzbeauftragte des Bundeslandes, in dem unser Unternehmen seinen Sitz hat. Eine Liste der Datenschutzbeauftragten sowie deren Kontaktdaten können folgendem Link entnommen werden: <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html" target="_blank">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_linksnode.
    html</a>.</p>
    ...
    <h2>3. Datenerfassung auf unserer
    Website</h2>
    <h3>Cookies</h3>
    ...
    <ul style="margin-left: 20px;margin-bottom:15px;">
        <li style="font-size:16px;line-height:20px;">Browsertyp und Browserversion</li>
        <li style="font-size:16px;line-height:20px;">verwendetes Betriebssystem</li>
        <li style="font-size:16px;line-height:20px;">Referrer URL</li>
        <li style="font-size:16px;line-height:20px;">Hostname des zugreifenden Rechners</li>
        <li style="font-size:16px;line-height:20px;">Uhrzeit der Serveranfrage</li>
        <li style="font-size:16px;line-height:20px;">IP-Adresse</li>
    </ul>
    ...
    <p>AuftragsdatenverarbeitungWir haben mit Google einen Vertrag zur Auftragsdatenverarbeitung abgeschlossen und setzen die
    strengen Vorgaben der deutschen Datenschutzbehörden bei der Nutzung von Google Analytics
    vollständig um.</p> <p><strong>Demografische Merkmale bei Google Analytics</strong></p>
