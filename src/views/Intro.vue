<template>
  <curved class="gradient min-h-0 lg:min-h-screen" v-bind:skipBorderTop="isDesktop" v-bind:usePaddingTop="true" id="intro">
    <div class="container xl:max-w-screen-lg 2xl:max-w-screen-2xl mx-auto text-white lg:mt-24 xl:mt-16 clearfix">
      <div class="float-none lg:float-right w-4/5 lg:w-1/3 pb-4 text-center px-4 md:px-0">
      ...
      <div class="float-none lg:float-right 2xl:float-left w-full lg:w-3/5 px-4 md:px-0">
        ...
        <span class="inline md:block lg:text-xl lg:text-2xl">Ahoi! Wir setzen Ihre Segel und lichten den Anker auf dem Weg zu neuen Ufern! </span>
        <span class="inline md:block lg:text-xl lg:text-2xl ">Wir entwickeln Software für Ihre digitalen Prozesse und Geschäftsmodelle.</span>
